                ...
                <div class="p-8 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div v-if="isSuperAdmin" class="space-y-1.5">
                            ...
                            <div class="relative">
                                <select v-model="form.prefix" :disabled="isEditing" :class="['w-full bg-white border rounded-lg px-4 py-2.5 text-sm appearance-none focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all', showErrors && !form.prefix ? 'border-red-300' : 'border-slate-200']">
...
const filteredAccounts = computed(() => {
    return props.globalState.accounts.filter(a => {
        ...
        const matchRole = filters.role === 'ALL' || getRoleName(a.roleId) === filters.role;
        ...
        const matchDept = !filters.department || a.department.toLowerCase().includes(filters.department.toLowerCase());
        const matchIp = !filters.lastLoginIp || a.lastLoginIp.includes(filters.lastLoginIp);
